...
class MathBattleGame1:
    def __init__(self, screen, hero, username):
        ...
        self.flash_duration = 1500

        self.damage_texts = []  # [{"text": "-30", "pos": (x,y), "start_time": t}]
    # New question
    ...
    def draw(self):
        ...
        question_rect = question_surf.get_rect(center=(self.screen.get_width() >> 1, 200))
    ...
    def run(self):
        ...
        while running:
                    ...
                    if self.game_over:
                        ...
                        try:
                            if int(self.user_input) == self.answer:  # Correct answer
                                ...
                                update_mistake_book1234(self.username, "chapter1", self.question, self.user_input,
                                                        self.answer)
                                ...
                                if self.calculate_dodge():
                                    ...
                                    dmg_x = 10 + 160
                                    dmg_y = 60
                                    self.add_damage_text(f"-{self.dragon_attack}", (dmg_x, dmg_y), (60, 255, 60)) # Add into the damage list
            ...
            if not self.game_over and elapsed > self.time_limit:
                # Update this question into mistake book
                update_mistake_book1234(self.username, "chapter1", self.question, "", self.answer)
                # Check whether a dodge has been made.
                if self.calculate_dodge():
                    self.dodge_flash_time = pygame.time.get_ticks()
