    ...
    def run(self):
        ...
        while running:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if self.game_over:
                        ...
                        if is_number(self.user_input):
                            # 浮点数比较，允许误差0.01
                            if abs(float(self.user_input) - self.answer) < 0.01:
                                ...
                                update_mistake_book123(self.username, "chapter2", self.question, self.user_input, self.answer)
                        ...
                        if (event.unicode.isdigit() or event.unicode == '.' or (event.unicode == '-' and len(self.user_input) == 0)):
                            # 防止多个小数点
            ...
            if not self.game_over and elapsed > self.time_limit:
                update_mistake_book123(self.username, "chapter2", self.question, "", self.answer)
